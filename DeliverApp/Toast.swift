    ...
    public func toastViewForMessage(_ message: String?, title: String?, image: UIImage?, style: ToastStyle) throws -> UIView {
        ...
        if let title = title {
            ...
            if let titleSize = titleSize {
                titleLabel?.frame = CGRect(x: 0.0, y: 0.0, width: titleSize.width, height: titleLabel?.intrinsicContentSize.height ?? 0.0)
            }
        }
...
public struct ToastStyle {
    ...
    */
    public var titleFont: UIFont = (UIFont(name: "Futura", size: 19.0))!
    
    /**
     The message font. Default is `.systemFont(ofSize: 16.0)`.
    */
    public var messageFont: UIFont = (UIFont(name: "Futura", size: 19.0))!
